    ...
    {{--  投稿情報  --}}
      <div class="model-info"> 
          ...
          <div class="card-method">
              <h2>[作り方]</h2>
              <p class="mb-0">
              1. 木板4を電動ルータで形を整える。 <br>
              2. 木板1と木板2上下穴の開いた直方体を作り、ボンドで固定しビスで固定する。<br>
              3. これを２つ作り、下の穴のほうを木板３でふさぎ、ボンドで固定しビスで固定する。<br>
              4. 写真のように木板4を乗せボンドで固定しビスで固定する。
              </p>
          </div>
