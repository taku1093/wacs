...
<!-- <model-viewer>を使って、3Dを、WEBサイトに埋め込む例 -->
    ...
    <model-viewer 
      ...
      auto-rotate 
      poster="hoge.png" 
      src="{{ asset('img/simulation/coatStand.gltf') }}"  
      exposure="0.6" 
      alt="" >
    </model-viewer>
      ...
      <div class="model-info"> 
          ...
          <div class="card-header">
              <dl class="post-header">
                  {{--  投稿タイトル  --}}
                  <dt class="title"><h2 class="mb-0 res-mb-0">コートスタンド</h2></dt>
              </dl>
          </div>
          ...
          <div class="card-exp">
              <h2>[説明]</h2>
              <p class="mb-0">コートを掛けることのできるスタンドを紹介します。
              </p>
          </div>
          ...
          <div class="card-method">
              <h2>[作り方]</h2>
              <p class="mb-0">木板の真ん中を削り、十字状となっている木を作成する。先ほど作成したもの交点に丸棒をビスで固定し適した高さにフックを取り付ける。</p>
          </div>
