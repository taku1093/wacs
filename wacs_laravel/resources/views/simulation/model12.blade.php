...
<!-- <model-viewer>を使って、3Dを、WEBサイトに埋め込む例 -->
    ...
    <model-viewer 
      ...
      auto-rotate 
      poster="hoge.png" 
      src="{{ asset('img/simulation/venchi.gltf') }}"  
      exposure="0.6" 
      alt="" >
    </model-viewer>
      ...
      <div class="model-info"> 
          ...
          <div class="card-header">
              <dl class="post-header">
                  {{--  投稿タイトル  --}}
                  <dt class="title"><h2 class="mb-0 res-mb-0">ガーデンベンチ</h2></dt>
              </dl>
          </div>
          ...
          <div class="card-exp">
              <h2>[説明]</h2>
              <p class="mb-0">お庭におくととてもおしゃれなベンチです。</p>
          </div>
          ...
          <div class="card-method">
              <h2>[作り方]</h2>
              <p class="mb-0">
                木材を2種類の用途でカットしたものを紙やすりで整えた後、写真のようにビスで固定していく<br>
                座面・・・200mm×1000mm<br>
                脚・・・30mm×50mm 長さ140mm
              </p>
          </div>
