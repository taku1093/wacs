...
<!-- <model-viewer>を使って、3Dを、WEBサイトに埋め込む例 -->
    ...
    <model-viewer 
      ...
      auto-rotate 
      poster="hoge.png" 
      src="{{ asset('img/simulation/osharedesk.gltf') }}"  
      exposure="0.6" 
      alt="" >
    </model-viewer>
      ...
      <div class="model-info"> 
          ...
          <div class="card-header">
              <dl class="post-header">
                  {{--  投稿タイトル  --}}
                  <dt class="title"><h1 class="mb-0 res-mb-0">お金持ちの家にありそうな机</h1></dt>
              </dl>
          </div>
          ...
          <div class="card-exp">
              <h2>[説明]</h2>
              <p class="mb-0">
                お金持ちの家においてありそうなおしゃれな机の紹介をします。<br>
                天板の光沢感を出すために研磨をしっかりとしています。
              </p>
          </div>
